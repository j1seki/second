...
export type LogoRakuten2IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function LogoRakuten2Icon(props: LogoRakuten2IconProps) {
...
export default LogoRakuten2Icon;
/* prettier-ignore-end */
